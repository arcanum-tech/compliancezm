...
const BRAND = { bg: "#7c3aed", dark: "#5b21b6", light: "#f5f3ff", logo: "ComplianceZM ✅", key: "compliancezm_session" };
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-b-2xl border border-t-0 shadow-lg px-6 py-6">
            ...
            <p className="text-center text-xs text-gray-400 mt-4">
              Your PIN secures your business data.<br />ARCANUM TECH LIMITED · TPIN 2003723894
            </p>
          </div>
        </div>
      </main>
